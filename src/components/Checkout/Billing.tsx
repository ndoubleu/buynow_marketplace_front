      ...
      <div className="bg-white shadow-1 rounded-[10px] p-4 sm:p-8.5">
        ...
        <div className="mb-5">
          ...
          <div className="relative">
            <select className="w-full bg-gray-1 rounded-md border border-gray-3 text-dark-4 py-3 pl-5 pr-9 duration-200 appearance-none outline-none focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20">
              ...
              <option value="2">Джизак</option>
              <option value="2">Кашкадарья</option>
              <option value="2">Навои</option>
              <option value="2">Наманган</option>
              <option value="2">Самарканд</option>
              <option value="2">Сурхандарья</option>
              <option value="2">Сырдарья</option>
              <option value="2">Фергана</option>
              <option value="2">Хорезм</option>
              <option value="2">Республика Каракалпакстан</option>
            </select>
        ...
        <div className="mb-5">
          ...
          <div className="mt-5">
            <input
              ...
              name="address"
              id="addressTwo"
              placeholder="Квартира, люкс, блок и т. д."
              className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
            />
          </div>
        </div>
        ...
        <div className="mb-5">
          <label htmlFor="town" className="block mb-2.5">
            Город <span className="text-red">*</span>
          </label>
        ...
        <div className="mb-5.5">
          <label htmlFor="email" className="block mb-2.5">
            Адрес электронной почты <span className="text-red">*</span>
          </label>
