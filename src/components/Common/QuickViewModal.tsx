            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-5 mb-6">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    <span className="font-medium text-dark"> {product.votes_rating || 0} Рейтинг </span>
                    <span className="text-dark-2"> ({product.reviews} Просмотры) </span>
                  </span>
                </div>
              </div>

              <p>Платформа: {product.properties?.platform?.title || ''}</p>
              <p>Рендер: {product.properties?.render?.title || ''}</p>
              <p>Размер KB: {product.properties?.size_kb || ''}</p>
